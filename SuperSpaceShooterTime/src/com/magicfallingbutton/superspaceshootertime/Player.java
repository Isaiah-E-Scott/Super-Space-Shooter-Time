...
public class Player {
	...
	private ArrayList<Projectile> waves = new ArrayList<Projectile>();
	...
	public void explode() {
		Explosion e = new Explosion(centerX - 62, centerY - 75);
		explosions.add(e);
	}

	public void shoot() {
		if (readyToFire) {
			Projectile p = new Projectile(centerX - 62, centerY - 75);
			projectiles.add(p);
		}
	}
	...
	public void waveShoot() {
		if (readyToFire) {
			Projectile w = new Projectile(245, centerY - 75);
			waves.add(w);
		}
	}
	
	public void shoot(int sX) {
		if (readyToFire) {
			Projectile p = new Projectile(centerX - 62, centerY - 75, sX);
			projectiles.add(p);
		}
	}
	...
	public ArrayList<Projectile> getWaves() {
		return waves;
	}
